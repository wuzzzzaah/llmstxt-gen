...
| `extensions` | list of strings | `[".py", ".js", ".jsx", ".ts", ".tsx", ".go", ".rb"]` | File extensions to consider. Files with any other extension are ignored. |
...
| `languages` | list of strings | `["python", "typescript", "go", "ruby"]` | Parsers to activate. Supported values: `python`, `typescript`, `go`, `ruby`. |
