...
> AST-aware `llms.txt` generator for Python, JavaScript/TypeScript, Go, Ruby, Java, C#, Rust, and Scala codebases.
...
From the root of any supported project:
...
| `extensions` | list of strings | `[".py", ".js", ".jsx", ".ts", ".tsx", ".go", ".rs", ".rb", ".java", ".cs", ".scala", ".sc"]` | File extensions to consider |
...
| `languages` | list of strings | `["python", "typescript", "go", "ruby", "java", "csharp", "rust", "scala"]` | Parsers to activate |
