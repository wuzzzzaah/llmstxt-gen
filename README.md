...
> AST-aware `llms.txt` generator for Python, JavaScript/TypeScript, Go, and Ruby codebases.
...
From the root of any Python, JavaScript/TypeScript, Go, or Ruby project:
...
| `extensions` | list of strings | `[".py", ".js", ".jsx", ".ts", ".tsx", ".go", ".rb"]` | File extensions to consider |
...
| `languages` | list of strings | `["python", "typescript", "go", "ruby"]` | Parsers to activate |
...
Today: Python, JavaScript/TypeScript, Go, Ruby.

Next: Rust, Java, C# — in that order. The full plan with rationale, scope, and contribution instructions lives in [docs/roadmap.md](docs/roadmap.md).
