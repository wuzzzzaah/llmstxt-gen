...
> AST-aware `llms.txt` generator for Python, JavaScript/TypeScript, Go, Java, Ruby, C#, Rust, and PHP codebases.
...
From the root of any supported project (Python, JavaScript/TypeScript, Go, Java, Ruby, C#, Rust, PHP):
...
| `extensions` | list of strings | `[".py", ".js", ".jsx", ".ts", ".tsx", ".go", ".rb", ".java", ".cs", ".rs", ".php"]` | File extensions to consider |
...
| `languages` | list of strings | `["python", "typescript", "go", "java", "ruby", "csharp", "rust", "php"]` | Parsers to activate |
...
Today: Python, JavaScript/TypeScript, Go, Java, Ruby, C#, Rust, PHP.
