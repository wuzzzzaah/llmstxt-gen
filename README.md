...
> AST-aware `llms.txt` generator for Python, JavaScript/TypeScript, Go, and Kotlin codebases.
...
From the root of any Python, JavaScript/TypeScript, Go, or Kotlin project:
...
| `extensions` | list of strings | `[".py", ".js", ".jsx", ".ts", ".tsx", ".go", ".kt", ".kts"]` | File extensions to consider |
...
| `languages` | list of strings | `["python", "typescript", "go", "kotlin"]` | Parsers to activate |
...
Today: Python, JavaScript/TypeScript, Go, Kotlin.
