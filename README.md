...
> AST-aware `llms.txt` generator for Python, JavaScript/TypeScript, Go, and C# codebases.
...
From the root of any Python, JavaScript/TypeScript, Go, or C# project:
...
| `extensions` | list of strings | `[".py", ".js", ".jsx", ".ts", ".tsx", ".go", ".cs"]` | File extensions to consider |
...
| `languages` | list of strings | `["python", "typescript", "go", "csharp"]` | Parsers to activate |
...
Today: Python, JavaScript/TypeScript, Go, C#.

Next: Rust, Ruby, Java — in that order. The full plan with rationale, scope, and contribution instructions lives in [docs/roadmap.md](docs/roadmap.md).
