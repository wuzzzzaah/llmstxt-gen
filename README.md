...
> AST-aware `llms.txt` generator for Python, JavaScript/TypeScript, Go, and Elixir codebases.
...
From the root of any Python, JavaScript/TypeScript, Go, or Elixir project:
...
| `extensions` | list of strings | `[".py", ".js", ".jsx", ".ts", ".tsx", ".go", ".rb", ".java", ".cs", ".rs", ".ex", ".exs"]` | File extensions to consider |
...
| `languages` | list of strings | `["python", "typescript", "go", "ruby", "java", "csharp", "rust", "elixir"]` | Parsers to activate |
...
Today: Python, JavaScript/TypeScript, Go, Ruby, Java, C#, Rust, Elixir.
