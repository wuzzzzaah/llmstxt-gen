...
### Added
- Elixir parser backed by tree-sitter-elixir. Extracts `@moduledoc`, public functions/macros, structs, behaviours, and protocols. Handles multiple function heads and `@spec` type hints.
